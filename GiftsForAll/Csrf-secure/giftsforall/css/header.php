                ...
                <div class="container">
                  ...
                  <a class="text-white" data-bs-target="#menu" data-bs-toggle="collapse" aria-expanded="false" aria-controls="menu"><i class="bi cp bi-list float-end fs-1 dmji"></i></a> 
                    ...
                    <ul id="menu" class=" navcol fw-bold d-none d-md-inline-flex">
                        ...
                        <li class="p-21 px-4"><a class="text-white" href="product.php">Flowers</a></li>
                        <li class="p-21 px-4"><a class="text-white" href="product.php">Chocolates and cookies</a></li>
                        <li class="p-21 px-4"><a class="text-white" href="product.php">Home and living</a></li>
                        <li class="p-21 px-4"><a class="text-white" href="product.php">Kids</a></li>
                        <li class="p-21 px-4"><a class="text-white" href="product.php">Gift cards</a></li>
                    </ul>
                </div>
            </div>
        </header>
